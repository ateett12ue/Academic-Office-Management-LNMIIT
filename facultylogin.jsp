...
<body>
  ...
  pwd=request.getParameter("password"); String user = "admin"; String password =
  "123456789"; %> <% if(password.equals(pwd) && user.equals(userid)){
  out.println("welcome"+userid); response.sendRedirect("FacultyHome.html"); }
